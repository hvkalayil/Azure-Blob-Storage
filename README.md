# Hi Bhushan
I have created this repo based on official @azure/blob package samples. Update the file azureAdAuth.js with TENANT_ID , CLIENT_ID , STORAGE_ACCOUNTNAME , CONTAINER NAME and run using commands mentioned in Setup
---
page_type: sample
languages:
  - typescript
